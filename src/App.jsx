...
function App() {
  ...
  useEffect(() => {
    triangulo.color === cuadrado.color &&
      circulo.color === cuadrado.color &&
      alert("Todas las figuras tienen el mismo color");
  }, [triangulo.color, cuadrado.color, circulo.color]);
  useEffect(() => {
    triangulo.numero === cuadrado.numero &&
      circulo.numero === cuadrado.numero &&
  ...
  return (
    <div className="App">
      ...
      {/* Usa ingles para todo, por coherencia también (state, setter) */}
